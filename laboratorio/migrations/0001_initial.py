# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-04-24 06:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.IntegerField(choices=[(0, 'Activo'), (1, 'Inactivo')], null=True)),
        ...
        migrations.AddField(
            model_name='avance',
            name='proyecto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='avances', to='laboratorio.Proyecto'),
        ),
    ]
